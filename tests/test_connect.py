...
class ConnectTestCase(BaseTarantoolTestCase):
    ...
    async def test__connect(self):
        ...
        self.assertIn(self.TESTER_SPACE_NAME, conn.schema.spaces)
        self.assertIn(self.TESTER_SPACE_ID, conn.schema.spaces)
        self.assertIs(conn.schema.spaces[self.TESTER_SPACE_NAME], conn.schema.spaces[self.TESTER_SPACE_ID])

        sp = conn.schema.spaces[self.TESTER_SPACE_NAME]
